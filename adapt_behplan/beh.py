...
class BehaviorPlanningNode(Node):
    ...
    def start_trigger_callback(self, msg):
        try:
            ...
            self.get_logger().error(f"Error processing start trigger message: {str(e)}")
    ...
    def adapt_envmod_callback(self, msg):
        try:
            ...
            self.get_logger().error(f"Error processing adapt_envmod message: {str(e)}")
    ...
    def adapt_loc_callback(self, msg):
        try:
            ...
            self.get_logger().error(f"Error processing adapt_loc message: {str(e)}")
    ...
    def adapt_roucomp_callback(self, msg):
        try:
            ...
            self.get_logger().error(f"Error processing adapt_roucomp message: {str(e)}")
    ...
    def adapt_trajp_callback(self, msg):
        try:
            ...
            self.get_logger().error(f"Error processing adapt_trajp message: {str(e)}")
    ...
    def behavior_planning_callback(self):
        try:
            ...
            self.get_logger().error(f"Error in behavior planning callback: {str(e)}")
    ...
    def idle_state(self):
        try:
            ...
            self.get_logger().error(f"Error in idle state transition: {str(e)}")
    ...
    def driving_state(self):
        try:
            ...
            self.get_logger().error(f"Error in driving state logic: {str(e)}")
    ...
    def park_state(self):
        try:
            ...
            self.get_logger().error(f"Error in park state logic: {str(e)}")
    ...
    def initiate_parking(self):
        try:
            ...
            self.get_logger().error(f"Error in initiate parking: {str(e)}")
