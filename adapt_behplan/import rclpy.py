...
class Behplan(Node):
    ...
    def timer_callback(self):
        ...
        self.get_logger().info(
            'Publishing maneuver commands Linear Velocity: %f, Angular Velocity: %f' % (twist_msg.linear.x,
                                                                                        twist_msg.angular.z))
        self.i += 1
    ...
    def localization_callback(self, msg):
        # Access pose data within PoseStamped
        pose_data = msg.pose
        self.get_logger().info('loc_pose - Position: x=%f, y=%f, z=%f' % (pose_data.position.x,
