...
| Trigger | /vi_start|string| Start trigger to transition into Drive State | |
| Outcome |/route|PoseArray| A optimum route from the vehicle's location to the parking spot |
